            ...
            <div className="grid md:grid-cols-2 mt-8 ">
              ...
              <div className="flex items-center justify-center">
                <p>
                  ...
                  <br />
                  <br />
                  The communities wants and needs are always at great interest
                  to us, as we like to shape the community and all of it's
                  features around it's members. This means that we love feedback
                  on anything, whether it's a game server, the Discord server or
                  the content we put out, we want to know how you feel about the
                  way the community is going. We are always more than happy to
                  have more people join the family so if you are interested make
                  sure to join the heart of our community, our Discord server.
